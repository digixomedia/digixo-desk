...
import { ArrowLeft, Phone, Mail, PlusCircle, ShoppingCart, Clock } from "lucide-react";
import { formatMoney, formatDate } from "@/lib/format";
import type { Customer, Sale, Payment, Subscription } from "@/lib/types";
...
export function CustomerProfilePage() {
  ...
  // Outstanding: per-sale remaining balance for pending/partial sales only, never negative
  ...
  // Active subscriptions: only count those whose original sale is activated or completed
  ...
  return (
    <PageContainer>
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <p className="text-lg font-semibold text-destructive">{formatMoney(refunded)}</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4">
        ...
        {/* Payments — keyed by customer id to force remount on navigation, preventing cross-customer leakage */}
        <div key={`payments-${id}`}>
          {paymentsLoading ? (
            <Card>
              <CardHeader className="pb-3">
